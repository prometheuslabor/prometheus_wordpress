...
<div class="wptypes_body">
     <?php if (!is_paged()): ?>
	  ...
	  <?php get_sidebar('header_sidebar_left'); ?>
	  <?php get_sidebar('header_sidebar_right'); ?>
	  </div>
        </div>
     <? endif; ?>
		<div class="middcolwrapper">
...
;(function($) {
    $.fn.textfill = function(options) {
        ...
        //var ourText = $(this).text();;
        //var sidebar_rt_ht = $(".header_sidebar_right").height();
        var sidebar_lt_ht = $(".header_sidebar_left").height();
        //var headerwrapper = $("#headerwrapper2").height();
        var maxHeight = sidebar_lt_ht - (sidebar_lt_ht * .23);
        var textHeight;
        var textWidth;
        do {
...
jQuery(window).resize(function($) {
    ...
    jQuery('.jtextfill').textfill({ maxFontPixels: 36 });
        }, 500);
});
</script>
