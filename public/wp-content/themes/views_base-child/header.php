...
<body <?php body_class(); ?>>
	...
	<header id="masthead" class="site-header" role="banner">	
		...
		<?php }?>
			...
			<a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home" style="display: inline-block;" ><img src="<?php echo esc_url( $header_image ); ?>" alt=""/></a>
			</div>
			<div class="login-area">
			<?php get_sidebar('masthead_sidebar'); ?>
			</div>
			</div>
		<?php endif; ?>
