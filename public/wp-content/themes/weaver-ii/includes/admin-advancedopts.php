...
<p>
    ...
    <br />
		<textarea name="<?php weaverii_sapi_advanced_name('wii_head_opts'); ?>" rows=5 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt('wii_head_opts')); ?></textarea>
<br>
...
<textarea name="<?php weaverii_sapi_advanced_name('wii_add_css'); ?>" rows=7 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt('wii_add_css')); ?></textarea>
...
<p>
    ...
    blocks to the &lt;head&gt; section.
		...
		<textarea name="<?php weaverii_sapi_advanced_name('_wii_althead_opts'); ?>" rows=2 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt('_wii_althead_opts')); ?></textarea>
...
?>
    <br />
    <textarea name="<?php weaverii_sapi_advanced_name($area_name); ?>" rows=3 style="width: 95%"><?php weaverii_esc_textarea(weaverii_getopt($area_name)); ?></textarea>
    <br />
