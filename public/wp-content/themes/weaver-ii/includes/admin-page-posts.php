...
5 Columns</option>
	...
	<br />
<?php
    weaverii_page_checkbox('wvr_pwp_compact', 'For posts with <em>Post Format</em> specified, use compact layout on blog/archive pages.');
}
...
function weaverii_save_post_fields($post_id) {
	...
	'replace_horiz_header','wvr_pwp_masonry','wvr_pwp_compact'
	);
if (weaverii_allow_multisite()) {
