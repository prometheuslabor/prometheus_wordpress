...
<?php	if (weaverii_init_base()) { ?>
	    <input name="<?php weaverii_sapi_advanced_name($rid); ?>" type="text" style="width:240px;height:22px;" class="regular-text"
...
<?php	} else { ?>
	    ...
	    <input name="<?php weaverii_sapi_advanced_name($rid); ?>" type="hidden" style="width:240px;height:22px;" class="regular-text"
		name="<?php echo $rid; ?>" id="<?php echo $rid; ?>" value="<?php esc_textarea(weaverii_getopt($rid)); ?>" />
